    ...
    def get_all_contacts(self):
        ...
        for person in connections:
            ...
            if birthdays:
                ...
                attributes.append(
                    GoogleAttribute('birthday', b_string, 'birthdays'))
            ...
            if email_addresses:
                for email_address in email_addresses:
                    attributes.append(
                        GoogleAttribute('email', email_address.get('value'),
                                        'emailAddresses'))
            ...
            if phone_numbers:
                for phone_number in phone_numbers:
                    attributes.append(
                        GoogleAttribute('tel', phone_number.get('value'),
                                        'phoneNumbers'))

            contact = GoogleContact(display_name, self.core, contact_id,
                                    attributes, notes)
